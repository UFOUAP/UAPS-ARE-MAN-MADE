...
(THE BIG DISCLOSURE) Essientially we have a spy surveillance sensor, that is being lowered down into the atmosphere,  on the end of a stiff fishing line. Which explains why the objects shot down have been found to have "STRINGS" attached to them. Additionally the might use plastic shells to prevent the device from being snagged in the wind. Coat the capsule/tic-tac with teflon and or a reflective MYLAR and the object will look metallic. 
